                ...
                <div className="flex flex-col items-center space-y-4">
                  <div className="relative">
                    ...
                    <label
                      ...
                      className="absolute bottom-0 right-0 h-12 w-12 bg-orange-500 rounded-xl flex items-center justify-center cursor-pointer shadow-lg hover:shadow-xl hover:bg-orange-600 transition-all"
                    >
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            ...
            {currentStep < totalSteps ? (
              <button
                ...
                className="flex items-center space-x-2 px-6 py-3 bg-orange-600 text-white font-semibold rounded-xl hover:bg-orange-700 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed group"
              >
                <span>Next</span>
              ...
              <button
                ...
                disabled={!isStepValid()}
                className="flex items-center space-x-2 px-8 py-3 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed group"
              >
