        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center gap-8">
              ...
              <div className="relative group">
                ...
                <button className="absolute bottom-0 right-0 bg-white text-orange-600 p-2.5 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-orange-100 text-lg mb-4 font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              ...
              { icon: Dumbbell, label: 'Total Workouts', value: '12', color: 'from-amber-400 to-orange-500', bg: 'from-amber-50 to-orange-50' },
              { icon: Target, label: 'Avg Accuracy', value: '87%', color: 'from-green-400 to-emerald-500', bg: 'from-green-50 to-emerald-50' },
              { icon: Clock, label: 'Total Time', value: '3.5h', color: 'from-red-400 to-orange-500', bg: 'from-red-50 to-orange-50' }
            ].map((stat, idx) => (
              <motion.div
                key={idx}
                initial={{ opacity: 0, y: 20 }}
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div className="p-6 space-y-3">
                  {[
                    ...
                    { icon: Target, title: 'Perfect Form', desc: 'Achieved 95% form accuracy', color: 'bg-orange-500' },
                    { icon: Flame, title: '3-Day Streak', desc: 'Work out for 3 days in a row', color: 'bg-red-500' }
                  ].map((achievement, idx) => (
                ...
                <div className="p-6">
                  <div className="flex items-center justify-center py-12">
                    <div className="text-center">
                      ...
                      <button className="mt-4 px-6 py-2.5 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl font-semibold hover:from-orange-600 hover:to-red-600 transition-colors shadow-md">
                        Start Training
                      </button>
                    </div>
                  </div>
